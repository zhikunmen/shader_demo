...
var Simple = (function (_super) {
    ...
    Simple.prototype.initUI = function () {
        return __awaiter(this, void 0, void 0, function () {
            var bg, customFilter, _a, _b, _c, stageH, stageW, inc, movex, movexTurn, movey, size;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        _c = [void 0, _d.sent()];
                        return [4 /*yield*/, getShader(ShaderConstant.F_SIMPLE)];
                    case 2:
                        customFilter = new (_b.apply(_a, _c.concat([_d.sent(), {}])))();
                        bg.filters = [customFilter];
                        stageH = egret.MainContext.instance.stage.stageHeight;
                        stageW = egret.MainContext.instance.stage.stageWidth;
                        inc = 0.5;
                        movex = 0;
                        movexTurn = true;
                        movey = 0;
